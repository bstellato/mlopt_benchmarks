...
#SBATCH --time=4-00:00
#SBATCH --gres=gpu:1
#SBATCH -o /scratch/gpfs/bs37/mlopt_research/results/online/obstacle/obstacle_train_%A_N%a.txt
...
python online_optimization/obstacle/training.py --n_obstacles $SLURM_ARRAY_TASK_ID
