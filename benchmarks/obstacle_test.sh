#!/bin/bash
#SBATCH --job-name=obstacletest
#SBATCH --array=4,6,8,10
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem-per-cpu=10G
#SBATCH --time=4-00:00
#SBATCH -o /scratch/gpfs/bs37/mlopt_research/results/online/obstacle/obstacle_test_%A_N%a.txt
...
python online_optimization/obstacle/testing.py --n_obstacles $SLURM_ARRAY_TASK_ID
...
# #SBATCH -o /home/gridsan/stellato/results/online/obstacle/obstacle_test_%A_N%a.txt
# #SBATCH --mail-type=END,FAIL,TIME_LIMIT
# #SBATCH --mail-user=bartolomeo.stellato@gmail.com
#
#
...
#
# # Run actual script
# HDF5_USE_FILE_LOCKING=FALSE python online_optimization/obstacle/testing.py --n_obstacles $SLURM_ARRAY_TASK_ID
#
